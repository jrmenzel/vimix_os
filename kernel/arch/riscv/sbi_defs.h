...
#define SBI_HSM_HART_STOPPED 1
#define SBI_HSM_HART_START_PENDING 2
#define SBI_HSM_HART_STOP_PENDING 3
#define SBI_HSM_HART_SUSPENDED 4
#define SBI_HSM_HART_SUSPEND_PENDING 5
#define SBI_HSM_HART_RESUME_PENDING 6
