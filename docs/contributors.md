...
`tools/extractdbg` to get the file name / line info from an ELF file was mostly done by AI. Some [usertests](userspace/tests/usertests.md) were also generated by AI.
