...
static bool datum_equiv(toml_datum_t a, toml_datum_t b)
{
    ...
    switch (a.type)
    {
        ...
        case TOML_INT64:
            ...
            //        case TOML_FP64:
            //            return a.u.fp64 == b.u.fp64 || (isnan(a.u.fp64) &&
            //            isnan(b.u.fp64));
                              ...
                              toml_datum_t *ret_datum)
{
    ...
    *ret_datum = mkdatum(TOML_ARRAY);
    ...
    for (;;)
    {
        ...
        if (!pelem)
        {
            return SETERROR(pp->ebuf, tok.lineno, "while parsing array: %s",
                            reason);
        }
...
static int parse_val(parser_t *pp, token_t tok, toml_datum_t *ret)
{
    ...
    switch (tok.toktyp)
    {
        ...
        case TOK_FLOAT:
        {
            ...
            return SETERROR(pp->ebuf, tok.lineno, "floats are unsupported");
        }
